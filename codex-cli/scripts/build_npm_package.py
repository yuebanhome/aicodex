#!/usr/bin/env python3
"""Stage and optionally package the @yuebanlaosiji/aicodex npm module."""
...
CODEX_NPM_NAME = "@yuebanlaosiji/aicodex"
CODEX_PACKAGE_COMPONENT = "codex-package"

# `npm_name` is the local optional-dependency alias consumed by `bin/aicodex.js`.
# The underlying package published to npm is always `@yuebanlaosiji/aicodex`.
CODEX_PLATFORM_PACKAGES: dict[str, dict[str, str]] = {
    "codex-linux-x64": {
        "npm_name": "@yuebanlaosiji/aicodex-linux-x64",
        "npm_tag": "linux-x64",
    ...
    "codex-linux-arm64": {
        "npm_name": "@yuebanlaosiji/aicodex-linux-arm64",
        "npm_tag": "linux-arm64",
    ...
    "codex-darwin-x64": {
        "npm_name": "@yuebanlaosiji/aicodex-darwin-x64",
        "npm_tag": "darwin-x64",
    ...
    "codex-darwin-arm64": {
        "npm_name": "@yuebanlaosiji/aicodex-darwin-arm64",
    ...
    "codex-win32-x64": {
        "npm_name": "@yuebanlaosiji/aicodex-win32-x64",
        "npm_tag": "win32-x64",
    ...
    "codex-win32-arm64": {
        "npm_name": "@yuebanlaosiji/aicodex-win32-arm64",
        "npm_tag": "win32-arm64",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build or stage the AICodex CLI npm package.")
    parser.add_argument(
        "--package",
        ...
        if release_version:
            ...
            if package == "codex":
                print(
                    ...
                    "Verify the CLI:\n"
                    f"    node {staging_dir_str}/bin/aicodex.js --version\n"
                    f"    node {staging_dir_str}/bin/aicodex.js --help\n\n"
                )
...
def stage_sources(staging_dir: Path, version: str, package: str) -> None:
    ...
    if package == "codex":
        ...
        shutil.copy2(CODEX_CLI_ROOT / "bin" / "aicodex.js", bin_dir / "aicodex.js")
    ...
    if package == "codex":
        package_json["files"] = ["bin/aicodex.js"]
